...
#define PanSource	"AltSwitch.pml"
...
#define nstates1	3	/* monitorStatus */
#define endstate1	2
short src_ln1 [] = {
	  0,  34,  35,   0, };
S_F_MAP src_file1 [] = {
...
#define nstates0	14	/* determineStatus */
#define endstate0	13
short src_ln0 [] = {
	  0,  10,  13,  15,  15,  16,  16,  15, 
	 19,  20,  22,  25,  28,  30,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "AltSwitch.pml", 1, 13 },
...
#define PmonitorStatus	((P1 *)this)
typedef struct P1 { /* monitorStatus */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 5; /* state    */
} P1;
#define Air1	(sizeof(P1) - 2)
#define PdetermineStatus	((P0 *)this)
typedef struct P0 { /* determineStatus */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 5; /* state    */
	uchar _3_altQuality;
...
#define Air0	(sizeof(P0) - Offsetof(P0, _3_hyst) - 1*sizeof(int))
