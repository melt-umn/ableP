...
#endif
		break;
	case 0:	/* determineStatus */
		((P0 *)pptr(h))->_t = 0;
		((P0 *)pptr(h))->_p = 1;
		reached0[1]=1;
		/* params: */
		/* locals: */
		((P0 *)pptr(h))->_3_altitude = 0;
		((P0 *)pptr(h))->_3_threshold = 0;
		((P0 *)pptr(h))->_3_hyst = 0;
		((P0 *)pptr(h))->_3_altQuality = 0;
		((P0 *)pptr(h))->_3_altStatus = 0;
#ifdef VAR_RANGES
		logval("determineStatus:altQuality", ((P0 *)pptr(h))->_3_altQuality);
		logval("determineStatus:altStatus", ((P0 *)pptr(h))->_3_altStatus);
		logval("determineStatus:altitude", ((P0 *)pptr(h))->_3_altitude);
		logval("determineStatus:threshold", ((P0 *)pptr(h))->_3_threshold);
		logval("determineStatus:hyst", ((P0 *)pptr(h))->_3_hyst);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
{	/* int i; */
	...
	case 1:
		...
		break;
	case 0:
		printf("local vars proc %d (determineStatus):\n", pid);
	printf("	int    altitude:	%d\n", ((P0 *)pptr(pid))->_3_altitude);
	printf("	int    threshold:	%d\n", ((P0 *)pptr(pid))->_3_threshold);
	printf("	int    hyst:	%d\n", ((P0 *)pptr(pid))->_3_hyst);
		break;
	}
}
...
{
	switch (x) {
	case 1: Printf("Below"); break;
	case 2: Printf("Above"); break;
	case 3: Printf("Unknown"); break;
	case 4: Printf("Bad"); break;
	case 5: Printf("Good"); break;
	default: Printf("%d", x);
	}
}
void
