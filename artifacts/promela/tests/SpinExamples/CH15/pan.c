/*** Generated by Spin Version 6.0.1 -- 16 December 2010 ***/
/*** From source: client_server.pml ***/
...
{	int j, h = now._nr_pr;
	...
	case 2:	/* Client */
		...
		/* params: */
		/* locals: */
		((P2 *)pptr(h))->_5_me = addqueue(1, 1);
		((P2 *)pptr(h))->_5_agent = 0;
#ifdef VAR_RANGES
#endif
#ifdef HAS_CODE
		locinit2(h);
	...
	case 1:	/* Server */
		...
		/* params: */
		/* locals: */
		((P1 *)pptr(h))->_4_agents[0] = addqueue(2, 1);
		((P1 *)pptr(h))->_4_agents[1] = addqueue(3, 1);
		((P1 *)pptr(h))->_4_pool = addqueue(4, 0);
		((P1 *)pptr(h))->_4_client = 0;
		((P1 *)pptr(h))->_4_agent = 0;
		((P1 *)pptr(h))->_4_i = 0;
#ifdef VAR_RANGES
		logval("Server:i", ((P1 *)pptr(h))->_4_i);
#endif
#ifdef HAS_CODE
		locinit1(h);
#endif
...
{	int i = 0;
	...
	{	if (t->ty[i] == TIMEOUT_F) return 1;
		...
		switch (t->qu[i]) {
		case 0: break;
		case 1: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( now.server) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( now.server) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( now.server) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( now.server) )))
			    ) return 0; break;
		case 2: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P0 *)this)->listen) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P0 *)this)->listen) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P0 *)this)->listen) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P0 *)this)->listen) )))
			    ) return 0; break;
		case 3: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P0 *)this)->talk) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P0 *)this)->talk) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P0 *)this)->talk) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P0 *)this)->talk) )))
			    ) return 0; break;
		case 4: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P1 *)this)->_4_agents[0]) )
			 ||     q_full((int) ( ((P1 *)this)->_4_agents[1]) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P1 *)this)->_4_agents[0]) )
			 ||    !q_full((int) ( ((P1 *)this)->_4_agents[1]) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P1 *)this)->_4_agents[0]) )
			 ||     !q_len((int) ( ((P1 *)this)->_4_agents[1]) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P1 *)this)->_4_agents[0]) )
			 ||      q_len((int) ( ((P1 *)this)->_4_agents[1]) )))
			    ) return 0; break;
		case 5: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P1 *)this)->_4_pool) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P1 *)this)->_4_pool) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P1 *)this)->_4_pool) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P1 *)this)->_4_pool) )))
			    ) return 0; break;
		case 6: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P1 *)this)->_4_client) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P1 *)this)->_4_client) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P1 *)this)->_4_client) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P1 *)this)->_4_client) )))
			    ) return 0; break;
		case 7: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P1 *)this)->_4_agent) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P1 *)this)->_4_agent) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P1 *)this)->_4_agent) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P1 *)this)->_4_agent) )))
			    ) return 0; break;
		case 8: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P2 *)this)->_5_me) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P2 *)this)->_5_me) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P2 *)this)->_5_me) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P2 *)this)->_5_me) )))
			    ) return 0; break;
		case 9: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P2 *)this)->_5_agent) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P2 *)this)->_5_agent) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P2 *)this)->_5_agent) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P2 *)this)->_5_agent) )))
			    ) return 0; break;
...
{	/* int i; */
	printf("global vars:\n");
	printf("	chan server (=%d):	len %d:\t", now.server, q_len(now.server));
	c_chandump(now.server);
}
void
...
{	/* int i; */
	...
	printf("	chan me (=%d):	len %d:\t", ((P2 *)pptr(pid))->_5_me, q_len(((P2 *)pptr(pid))->_5_me));
	c_chandump(((P2 *)pptr(pid))->_5_me);
	printf("	chan agent (=%d):	len %d:\t", ((P2 *)pptr(pid))->_5_agent, q_len(((P2 *)pptr(pid))->_5_agent));
	c_chandump(((P2 *)pptr(pid))->_5_agent);
		break;
	case 1:
		printf("local vars proc %d (Server):\n", pid);
	printf("	chan agents[0] (=%d):	len %d:\t", ((P1 *)pptr(pid))->_4_agents[0], q_len(((P1 *)pptr(pid))->_4_agents[0]));
	c_chandump(((P1 *)pptr(pid))->_4_agents[0]);
	printf("	chan agents[1] (=%d):	len %d:\t", ((P1 *)pptr(pid))->_4_agents[1], q_len(((P1 *)pptr(pid))->_4_agents[1]));
	c_chandump(((P1 *)pptr(pid))->_4_agents[1]);
	printf("	chan pool (=%d):	len %d:\t", ((P1 *)pptr(pid))->_4_pool, q_len(((P1 *)pptr(pid))->_4_pool));
	c_chandump(((P1 *)pptr(pid))->_4_pool);
	printf("	chan client (=%d):	len %d:\t", ((P1 *)pptr(pid))->_4_client, q_len(((P1 *)pptr(pid))->_4_client));
	c_chandump(((P1 *)pptr(pid))->_4_client);
	printf("	chan agent (=%d):	len %d:\t", ((P1 *)pptr(pid))->_4_agent, q_len(((P1 *)pptr(pid))->_4_agent));
	c_chandump(((P1 *)pptr(pid))->_4_agent);
	printf("	byte   i:	%d\n", ((P1 *)pptr(pid))->_4_i);
		break;
	case 0:
		printf("local vars proc %d (Agent):\n", pid);
	printf("	chan listen (=%d):	len %d:\t", ((P0 *)pptr(pid))->listen, q_len(((P0 *)pptr(pid))->listen));
	c_chandump(((P0 *)pptr(pid))->listen);
	printf("	chan talk (=%d):	len %d:\t", ((P0 *)pptr(pid))->talk, q_len(((P0 *)pptr(pid))->talk));
	c_chandump(((P0 *)pptr(pid))->talk);
		break;
	}
}
void
...
{
	switch (x) {
	case 1: Printf("return"); break;
	case 2: Printf("grant"); break;
	case 3: Printf("hold"); break;
	case 4: Printf("deny"); break;
	case 5: Printf("request"); break;
	default: Printf("%d", x);
	}
}
void
