#define SpinVersion	"Spin Version 6.0.1 -- 16 December 2010"
#define PanSource	"client_server.pml"
...
#define nstates2	16	/* Client */
#define endstate2	15
short src_ln2 [] = {
	  0,  52,  53,  55,  56,  57,  58,  59, 
	 60,  54,  62,  54,  51,  63,  51,  63, 
	  0, };
S_F_MAP src_file2 [] = {
	{ "-", 0, 0 },
	{ "client_server.pml", 1, 15 },
	{ "-", 16, 17 }
};
uchar reached2 [] = {
	  0,   1,   0,   1,   1,   1,   1,   0, 
...
#define nstates1	23	/* Server */
#define endstate1	22
short src_ln1 [] = {
	  0,  25,  25,  25,  26,  26,  24,  29, 
	 24,  30,  32,  33,  34,  35,  36,  31, 
	 38,  38,  39,  29,  41,  29,  41,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "client_server.pml", 1, 22 },
	{ "-", 23, 24 }
};
uchar reached1 [] = {
	  0,   1,   0,   0,   1,   1,   0,   1, 
...
#define nstates0	12	/* Agent */
#define endstate0	11
short src_ln0 [] = {
	  0,  10,  11,  11,  12,  13,  13,   9, 
	 15,   9,  15,  16,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "client_server.pml", 1, 11 },
	{ "-", 12, 13 }
};
uchar reached0 [] = {
	  0,   1,   1,   1,   1,   0,   1,   0, 
...
#define Air2	(sizeof(P2) - Offsetof(P2, _5_agent) - 1*sizeof(uchar))
#define PServer	((P1 *)this)
...
#define Air1	(sizeof(P1) - Offsetof(P1, _4_agents) - 2*sizeof(uchar))
#define PAgent	((P0 *)this)
typedef struct P0 { /* Agent */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 6; /* state    */
	uchar listen;
...
#define Air0	(sizeof(P0) - Offsetof(P0, talk) - 1*sizeof(uchar))
