-- Updated for SPIN Version 6.0 --- September 2010 ---
...
The file called 'pathfinder.pml' illustrates the use of
'provided' clauses (using as inspiration the bug in
the control software of the Mars pathfinder that
struck an otherwise perfect mission in July 1997)
...
test 7	check random number generator
	...
	$ spin -p -g -u10000 priorities.pml	# runs 10000 steps
	....
...
test 8	test the generation of never claims from LTL formulae:
	...
	accept_S9:
 	...
 	explore also the use of inline ltl formulae
