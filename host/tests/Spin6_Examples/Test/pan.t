...
{	Trans *T;
	...
	trans[0][2]	= settr(1,0,3,4,4,"b = (2*a)", 0, 2, 0);
	trans[0][3]	= settr(2,0,8,1,0,"(1)", 0, 2, 0);
	trans[0][7]	= settr(6,0,8,1,0,".(goto)", 0, 2, 0);
	trans[0][4]	= settr(3,0,5,5,5,"b = (2*a)", 0, 2, 0);
	trans[0][5]	= settr(4,0,8,1,0,"(1)", 0, 2, 0);
	trans[0][8]	= settr(7,0,9,6,6,"b = (b-1)", 0, 2, 0);
	trans[0][11]	= settr(10,0,12,1,0,"break", 0, 2, 0);
	trans[0][12]	= settr(11,0,0,7,7,"-end-", 0, 3500, 0);
	/* np_ demon: */
